...
| placement_constraints | The placement constraints to configure for the container. This is a list of maps, where each map should contain "type" and "expression" | object | `null` | no |
